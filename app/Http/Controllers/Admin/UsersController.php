...
class UsersController extends Controller
{
    ...
    public function create()
    {
        ...
        $jobtiles = Jobtitle::all()->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');

        $roles = Role::all()->pluck('title', 'id');

        return view('admin.users.create', compact('teams', 'jobtiles', 'roles'));
    }
    ...
    public function edit(User $user)
    {
        ...
        $user->load('team', 'jobtile', 'roles');

        return view('admin.users.edit', compact('teams', 'jobtiles', 'roles', 'user'));
    }
